...
var updateHandle = function (set_context) {
    ...
    if (context.server) {
        ...
        console.log('subscribing to reactive-table-' + context.collection);
...
Template.reactiveTable.helpers({
    ...
    'sortedRows': function () {
        console.log('sortedRows for reactive-table');
        ...
        if (this.server) {
            ...
            if (sortByValue) {
                ...
                // hack in a way to get the filtered and sorted collection
                this.getCachedCollection = function() {
                    return this.collection.find(this.lastFilterQuery, {
                        sort: this.lastSortQuery
                    });
                };
                this.lastFilterQuery = filterQuery;
                this.lastSortQuery = sortQuery;
